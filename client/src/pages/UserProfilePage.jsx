...
const UserProfilePage = () => {
  const { data: userProfile, loading: profileLoading, updateItem: updateProfile } = useApi('/api/user/profile');
  const { data: tasks } = useApi('/api/tasks');
  const { data: goals } = useApi('/api/goals');
